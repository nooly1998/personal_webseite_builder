...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_pagesPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>('wire_pages');
  late final _wire_pages = _wire_pagesPtr.asFunction<void Function(int)>();
